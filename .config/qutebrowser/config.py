...
#c.content.proxy = 'http://138.68.151.65:3128'
...
## Type: Int
c.downloads.remove_finished = 120
...
## Type: Font
# c.fonts.completion.category = 'bold 8pt Envy Code R'

## Font used in the completion widget.
## Type: Font
# c.fonts.completion.entry = '8pt Envy Code R'
...
## Type: Font
c.fonts.monospace = '"Iosevka Term", "Envy Code R", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
c.spellcheck.languages = ['en-GB', 'lt-LT']
...
## Type: Dict
c.url.searchengines = {'d': 'https://duckduckgo.com/?q={}', 'DEFAULT': 'https://google.com/search?q={}', 'pb': 'https://thepiratebay.org/search/{}'}
